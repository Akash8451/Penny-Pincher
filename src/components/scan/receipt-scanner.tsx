    ...
    <Card>
      <CardHeader>
        <CardTitle className='flex items-center gap-2'>
          <ScanLine className='text-primary' /> Receipt Itemizer
        </CardTitle>
        <CardDescription>
          Automatically extract items from a receipt to log them as individual expenses.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {renderContent()}
      ...
      {scanResult && (
        <CardFooter>
            <Button className='w-full md:w-auto ml-auto' onClick={handleLogSelected}><ListPlus className='mr-2 h-4 w-4' />Log Selected Items</Button>
        </CardFooter>
      )}
    </Card>
  );
